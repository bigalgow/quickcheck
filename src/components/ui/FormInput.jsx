  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        className="w-full rounded-md border-2 border-slate-300 px-3 py-2 text-base h-11 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 bg-white"
      />
    </div>
  );
}
